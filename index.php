...
<html lang="es">
    <head>
      <meta charset="utf-8">
      <title>JW Social Showroom</title>
      ...
      fbq('init', '1746387905634067');
      fbq('track', "PageView");</script>
      <noscript><img height="1" width="1" style="display:none"
      src="https://www.facebook.com/tr?id=1746387905634067&ev=PageView&noscript=1"
      /></noscript>
...
Hoy Rosa Clará es una empresa consolidada, en constante expansión, con presencia en los cinco continentes, y un referente en el sector.
           ...
           <div class="clients">
            <div class="row">
              ...
              <div class="client col-sm-3 col-xs-3">
                <img src="img/client19.png" alt="client">
              </div>
              <div class="client col-sm-3 col-xs-3">
                <img src="img/client20.png" alt="client">
              </div>
            </div>
          </div>
          ...
          <div id="contact" class="row">
              ...
              <form id="contact_form" class="row"  action="<?php echo "http://" . $_SERVER['SERVER_NAME'] .  '/registro.php'; ?>" method="POST" >
                ...
                <div class="col-sm-12 col-xs-12">
                  <button class="submit" type="button" name="Inscribirse" id="send_form_social_show">Inscribirse</button>
                  <!--<input  class="submit" type="button" name="Inscribirse" id="send_form_social_show">-->
                </div>
      ...
      <script type="text/javascript">
        ...
        $(document).on('ready',function(){
          ...
          $("#contact_form").validate({
            ...
            messages: {
                name_user: "Por favor Ingrese su nombre",
                tel_user: {
                    required: "Por favor ingrese su teléfono",
                    number:  "El teléfono debe ser un valor númerico"
                },
                email_user: {
          ...
          $(document).on('click','#send_form_social_show',function(e){
              e.preventDefault();
              if($('#contact_form').valid()){
                  //alert('si valido');
                  $.isLoading({ text: "Por favor espere, estamos procesando su inscripción..." });
                  $.ajax({
                     type: 'POST',
                     ...
                     success: function(data){
                      ...
                      $.isLoading({ text: "Su registro se ha completado con éxito, gracias por inscribirse" });
                      $('#contact_form')[0].reset();
                      setTimeout(function(){ $.isLoading( "hide" ); }, 3000);
                    }
                  });
              }else{
                //alert('no valido');
