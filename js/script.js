...
/* ------------------------------------- */
 ...
 $(function() {
  ...
  //  for (var i = 0; i < projectContainerList.length; i++) {
     ...
     var projectImg = $('<img class="main-thumb">');
...
/* ------------------------------------- */
  ...
  $('#clockHome')
  .countdown($('#clockHome').attr("data-date")).on('update.countdown', function(event) {
     var $this = $(this).html(event.strftime(''
       + '<div class="clock-box"><span>%-D</span> Day%!d </div>'
       + '<div class="clock-box"><span>%H</span>h </div>'
